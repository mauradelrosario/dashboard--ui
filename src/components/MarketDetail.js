...
class MarketDetail extends React.Component {
  render() {
    ...
    return (
      ...
      >
        <div className="dbs__pis__market-table__details--wrap-1">
        ...
        <div className="dbs__pis__market-table__details--wrap-2">
...
class MakeAnOffer extends React.Component {
  render() {
    return (
      <button className="btn dbs__pis__market-table__details__status-offer--btn">
        Make an offer
      </button>
    );
  }
